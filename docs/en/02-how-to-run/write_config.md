...
According to model's codebase, write the model config file. Model's config file is used to initialize the model, referring to [MMPretrain](https://github.com/vbti-development/onedl-mmpretrain/blob/main/docs/en/user_guides/config.md), [MMDetection](https://github.com/vbti-development/onedl-mmdetection/blob/main/docs/en/user_guides/config.md), [MMSegmentation](https://github.com/vbti-development/onedl-mmsegmentation/blob/main/docs/en/user_guides/1_config.md), [MMOCR](https://github.com/open-mmlab/mmocr/blob/main/docs/en/user_guides/config.md), [MMagic](https://github.com/open-mmlab/mmagic/blob/main/docs/en/user_guides/config.md).
