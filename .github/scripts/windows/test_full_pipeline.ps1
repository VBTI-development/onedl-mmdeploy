...
# prepare dataset
Invoke-WebRequest -Uri https://github.com/vbti-development/onedl-mmdeploy/releases/download/v0.1.0/imagenet-val100.zip -OutFile $pwd\data\imagenet-val100.zip
