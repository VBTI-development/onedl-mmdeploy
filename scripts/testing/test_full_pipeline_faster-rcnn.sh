...
work_dir=$mmdeploy_dir/work_dir_fasterrcnn
mkdir -p $work_dir $mmdeploy_dir/data/tiny_coco

model_cfg=$work_dir/faster-rcnn_r50_fpn_1x_coco.py
checkpoint=$work_dir/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth
sdk_cfg=configs/mmdet/detection/detection_sdk_dynamic.py
input_img=tests/data/tiger.jpeg

python3 -m mim download onedl-mmdetection --config faster-rcnn_r50_fpn_1x_coco --dest $work_dir
