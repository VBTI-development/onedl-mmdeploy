...
We provide nuget package on our [release page](https://github.com/vbti-development/onedl-mmdeploy/releases). Currently the prebuilt package only support tensorrt and onnxruntime backend.
